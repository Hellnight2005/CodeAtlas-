...
const SERVICE_NAME = process.env.SERVICE_NAME || "Repo_Parser";

// Log directory: /public/log/{SERVICE_NAME}/
// Assuming 'public' folder inside repo_parser or shared? 
// git_auth had "path.join(__dirname, '..', 'public', ...)"
// I'll assume local public folder for now.
